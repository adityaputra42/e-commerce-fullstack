...
type RoleService interface {
	...
	CreateRole(req *models.RoleInput) (*models.Role, error)
	UpdateRole(id uint, req *models.RoleInput) (*models.Role, error)
...
func (r *RoleServiceImpl) CreateRole(req *models.RoleInput) (*models.Role, error) {
...
func (r *RoleServiceImpl) UpdateRole(id uint, req *models.RoleInput) (*models.Role, error) {
