...
func InitializeAllHandler(config2 *config.Config) *Handler {
	...
	authHandler := handler.NewAuthHandler(authService, config2)
	...
	paymentService := services.NewPaymentService(paymentRepository, transactionRepository, orderRepository, productRepository)
