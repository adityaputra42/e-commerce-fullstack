    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 z-50 p-4">
        <button 
          ...
          className="p-2 bg-indigo-600 rounded-xl shadow-lg shadow-indigo-200 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all hover:scale-105 active:scale-95"
      ...
      >
        <div className="p-6 mb-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900 tracking-tight">Antigravity</h1>
              <p className="text-xs text-slate-500 font-bold uppercase tracking-wider opacity-60">Admin V1.0</p>
            </div>
          </div>
        </div>
              ...
              <li key={item.name}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center px-4 py-3 rounded-xl transition-all duration-200 group ${
                      isActive 
                        ? 'bg-indigo-50 text-indigo-600 font-bold shadow-sm shadow-indigo-100/50' 
                ...
                >
                  ...
                  <div className="ml-auto opacity-0 group-[.active]:opacity-100 transition-opacity">
                    <div className="w-1.5 h-1.5 rounded-full bg-indigo-600 shadow-lg shadow-indigo-200 animate-pulse"></div>
                  </div>
                </NavLink>
              </li>
            ))}
        ...
        <div className="p-4 mt-auto border-t border-slate-50">
          <div className="p-3 bg-slate-50 rounded-2xl flex items-center gap-3 group cursor-pointer hover:bg-slate-100 transition-colors">
              ...
              <div className="flex-1 overflow-hidden">
                  <p className="text-sm font-bold text-slate-900 truncate">Aditya Putra</p>
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-tight">Super Administrator</p>
              </div>
          </div>
        </div>
      </aside>
